...
public class ScheduleCapabilityExecutor
    ...
    @Value("${ai.prompt.version.SCHEDULE:0}")
    private Integer promptVersion;

    @Autowired
    public ScheduleCapabilityExecutor(
        ...
        LocalRuleFallback<ScheduleRequest, ScheduleResponse> localRuleFallback,
    ...
    protected AiResult<ScheduleResponse> doExecuteInternal(
        long startTime, ScheduleRequest request, String capabilityId,
