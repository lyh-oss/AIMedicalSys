...
@Service("ANALYSIS_REPORT_LABTEST")
public class AnalysisReportForLabTestCapabilityExecutor extends AbstractCapabilityExecutor<LabTestReportRequest, LabTestReportResponse> {

    private static final Logger log = LoggerFactory.getLogger(AnalysisReportForLabTestCapabilityExecutor.class);

    private final Phase4ServiceFacade<LabTestReportRequest, LabTestReportResponse> phase4Service;

    @Autowired
    public AnalysisReportForLabTestCapabilityExecutor(
        Phase4ServiceFacade<LabTestReportRequest, LabTestReportResponse> phase4Service,
    ...
    @Override public String getCapabilityId() { return "ANALYSIS_REPORT_LABTEST"; }
    @Override public Class<LabTestReportRequest> getInputType() { return LabTestReportRequest.class; }
    @Override public Class<LabTestReportResponse> getOutputType() { return LabTestReportResponse.class; }

    @Override
    protected String doExtractDepartmentId(LabTestReportRequest request) {
    ...
    @Override
    protected String doExtractVisitId(LabTestReportRequest request) {
    ...
    @Override
    protected String doExtractPatientId(LabTestReportRequest request) {
    ...
    @Override
    protected String doExtractSessionId(LabTestReportRequest request) {
    ...
    @Override
    protected AiResult<LabTestReportResponse> doExecuteInternal(
        long startTime, LabTestReportRequest request, String capabilityId,
        ...
        try {
            ...
            CompletableFuture<LabTestReportResponse> delegateFuture = CompletableFuture.supplyAsync(
                () -> phase4Service.execute(request), llmCallExecutor);
            LabTestReportResponse result = delegateFuture.get(resolvedTimeout, TimeUnit.MILLISECONDS);
    ...
    private boolean isDtoEmpty(LabTestReportRequest request) {
