...
public class ImageAnalysisCapabilityExecutor extends AbstractCapabilityExecutor<ImageAnalysisRequest, ImageAnalysisResponse> {

    private static final Logger log = LoggerFactory.getLogger(ImageAnalysisCapabilityExecutor.class);

    private final Phase4ServiceFacade<ImageAnalysisRequest, ImageAnalysisResponse> phase4Service;

    @Autowired
    public ImageAnalysisCapabilityExecutor(
        Phase4ServiceFacade<ImageAnalysisRequest, ImageAnalysisResponse> phase4Service,
    ...
    @Override public String getCapabilityId() { return "IMAGE_ANALYSIS"; }
    @Override public Class<ImageAnalysisRequest> getInputType() { return ImageAnalysisRequest.class; }
    @Override public Class<ImageAnalysisResponse> getOutputType() { return ImageAnalysisResponse.class; }

    @Override
    protected String doExtractDepartmentId(ImageAnalysisRequest request) {
    ...
    @Override
    protected String doExtractVisitId(ImageAnalysisRequest request) {
    ...
    @Override
    protected String doExtractPatientId(ImageAnalysisRequest request) {
    ...
    @Override
    protected String doExtractSessionId(ImageAnalysisRequest request) {
    ...
    @Override
    protected AiResult<ImageAnalysisResponse> doExecuteInternal(
        long startTime, ImageAnalysisRequest request, String capabilityId,
        ...
        try {
            ...
            CompletableFuture<ImageAnalysisResponse> delegateFuture = CompletableFuture.supplyAsync(
                () -> phase4Service.execute(request), llmCallExecutor);
            ImageAnalysisResponse result = delegateFuture.get(resolvedTimeout, TimeUnit.MILLISECONDS);
    ...
    private boolean isDtoEmpty(ImageAnalysisRequest request) {
