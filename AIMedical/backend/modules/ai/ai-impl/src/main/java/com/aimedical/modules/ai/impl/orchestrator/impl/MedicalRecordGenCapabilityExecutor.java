...
public class MedicalRecordGenCapabilityExecutor
    ...
    @Value("${ai.prompt.version.MEDICAL_RECORD_GEN:0}")
    private Integer promptVersion;

    @Autowired
    public MedicalRecordGenCapabilityExecutor(
        ...
        LocalRuleFallback<MedicalRecordGenRequest, MedicalRecordGenResponse> localRuleFallback,
    ...
    protected AiResult<MedicalRecordGenResponse> doExecuteInternal(
        long startTime, MedicalRecordGenRequest request, String capabilityId,
