...
public class PrescriptionAssistCapabilityExecutor
    ...
    @Value("${ai.prompt.version.RX_ASSIST:0}")
    private Integer promptVersion;

    @Autowired
    public PrescriptionAssistCapabilityExecutor(
        ...
        LocalRuleFallback<PrescriptionAssistRequest, PrescriptionAssistResponse> localRuleFallback,
    ...
    protected AiResult<PrescriptionAssistResponse> doExecuteInternal(
        long startTime, PrescriptionAssistRequest request, String capabilityId,
