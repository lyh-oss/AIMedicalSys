...
@Service("RECOMMEND_EXEC_ORDER")
public class RecommendExecutionOrderCapabilityExecutor extends AbstractCapabilityExecutor<ExecutionOrderRequest, ExecutionOrderResponse> {

    private static final Logger log = LoggerFactory.getLogger(RecommendExecutionOrderCapabilityExecutor.class);

    private final Phase4ServiceFacade<ExecutionOrderRequest, ExecutionOrderResponse> phase4Service;

    @Autowired
    public RecommendExecutionOrderCapabilityExecutor(
        Phase4ServiceFacade<ExecutionOrderRequest, ExecutionOrderResponse> phase4Service,
    ...
    @Override public String getCapabilityId() { return "RECOMMEND_EXEC_ORDER"; }
    @Override public Class<ExecutionOrderRequest> getInputType() { return ExecutionOrderRequest.class; }
    @Override public Class<ExecutionOrderResponse> getOutputType() { return ExecutionOrderResponse.class; }

    @Override
    protected String doExtractDepartmentId(ExecutionOrderRequest request) {
    ...
    @Override
    protected String doExtractVisitId(ExecutionOrderRequest request) {
    ...
    @Override
    protected String doExtractPatientId(ExecutionOrderRequest request) {
    ...
    @Override
    protected String doExtractSessionId(ExecutionOrderRequest request) {
    ...
    @Override
    protected AiResult<ExecutionOrderResponse> doExecuteInternal(
        long startTime, ExecutionOrderRequest request, String capabilityId,
        ...
        try {
            ...
            CompletableFuture<ExecutionOrderResponse> delegateFuture = CompletableFuture.supplyAsync(
                () -> phase4Service.execute(request), llmCallExecutor);
            ExecutionOrderResponse result = delegateFuture.get(resolvedTimeout, TimeUnit.MILLISECONDS);
    ...
    private boolean isDtoEmpty(ExecutionOrderRequest request) {
