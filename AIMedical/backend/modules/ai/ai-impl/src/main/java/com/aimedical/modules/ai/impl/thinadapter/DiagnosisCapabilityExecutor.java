...
public class DiagnosisCapabilityExecutor extends AbstractCapabilityExecutor<DiagnosisRequest, DiagnosisResponse> {
    ...
    @Override
    protected String doExtractDepartmentId(DiagnosisRequest request) {
    ...
    @Override
    protected String doExtractVisitId(DiagnosisRequest request) {
    ...
    @Override
    protected String doExtractPatientId(DiagnosisRequest request) {
    ...
    @Override
    protected String doExtractSessionId(DiagnosisRequest request) {
