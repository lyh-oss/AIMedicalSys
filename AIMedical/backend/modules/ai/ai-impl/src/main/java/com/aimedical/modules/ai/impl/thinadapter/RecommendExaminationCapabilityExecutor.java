...
@Service("RECOMMEND_EXAM")
public class RecommendExaminationCapabilityExecutor extends AbstractCapabilityExecutor<ExaminationRecommendRequest, ExaminationRecommendResponse> {

    private static final Logger log = LoggerFactory.getLogger(RecommendExaminationCapabilityExecutor.class);

    private final Phase4ServiceFacade<ExaminationRecommendRequest, ExaminationRecommendResponse> phase4Service;

    @Autowired
    public RecommendExaminationCapabilityExecutor(
        Phase4ServiceFacade<ExaminationRecommendRequest, ExaminationRecommendResponse> phase4Service,
    ...
    @Override public String getCapabilityId() { return "RECOMMEND_EXAM"; }
    @Override public Class<ExaminationRecommendRequest> getInputType() { return ExaminationRecommendRequest.class; }
    @Override public Class<ExaminationRecommendResponse> getOutputType() { return ExaminationRecommendResponse.class; }

    @Override
    protected String doExtractDepartmentId(ExaminationRecommendRequest request) {
    ...
    @Override
    protected String doExtractVisitId(ExaminationRecommendRequest request) {
    ...
    @Override
    protected String doExtractPatientId(ExaminationRecommendRequest request) {
    ...
    @Override
    protected String doExtractSessionId(ExaminationRecommendRequest request) {
    ...
    @Override
    protected AiResult<ExaminationRecommendResponse> doExecuteInternal(
        long startTime, ExaminationRecommendRequest request, String capabilityId,
        ...
        try {
            ...
            CompletableFuture<ExaminationRecommendResponse> delegateFuture = CompletableFuture.supplyAsync(
                () -> phase4Service.execute(request), llmCallExecutor);
            ExaminationRecommendResponse result = delegateFuture.get(resolvedTimeout, TimeUnit.MILLISECONDS);
    ...
    private boolean isDtoEmpty(ExaminationRecommendRequest request) {
