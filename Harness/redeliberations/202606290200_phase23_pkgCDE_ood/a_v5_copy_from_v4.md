...
| 分诊（非AI） | TRIAGE_ | TRIAGE_SESSION_EXPIRED、TRIAGE_FIELD_COMBINATION_INVALID、TRIAGE_SESSION_NOT_FOUND |
...
| 病历（非AI） | MR_GEN_ | MR_GEN_STREAM_NOT_SUPPORTED、MR_GEN_VISIT_NOT_FOUND、MR_GEN_CONCURRENT_MODIFICATION |
